...
<style>
    ...
    .product-found-card { border: 2px solid #27ae60; border-radius: 12px; padding: 1.5rem; background: #fff; }
    .result-item {
        cursor: pointer; padding: .7rem 1rem; border-bottom: 1px solid #eee; transition: background .15s;
    }
    .result-item:hover { background: #eaf4ff; }
...
<div class="row justify-content-center">
    <div class="col-md-7">
        ...
        <div class="search-zone mb-3">
            <i class="bi bi-box-seam" style="font-size:2.2rem;opacity:.85"></i>
        ...
        <div id="productFoundSection" class="product-found-card mb-3" style="display:none">
            <div class="d-flex align-items-center gap-3 mb-3">
                ...
                <div>
                    ...
                    <span class="badge bg-success mt-1" id="currentStockBadge">Stock: -</span>
                </div>
            </div>
            ...
            <form action="{{ route('stock.process') }}" method="POST">
                ...
                <div class="mt-3 d-flex gap-2">
                    <button type="submit" class="btn btn-success btn-lg flex-grow-1">
                        <i class="bi bi-plus-circle-fill me-2"></i>Add Stock
                    </button>
